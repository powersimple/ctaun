<?php
/*
	This page is a self contained module to include the animated spinning globe.
	include this page. 
...
/*SVG files are included separately so they can be commented out , reordered easily and use variations*/
      ...
      if(@$_GET['lang'] == 'es'){// Spanish Version Condition
       ...
       if(@$_GET['globe']){ // condition for loading spinnig globe.
...
function loadData(cb) {
  d3.json('https://raw.githubusercontent.com/n1n9-jp/CSIS_map_140514/master/data/world-50m.json', function(error, world) {
